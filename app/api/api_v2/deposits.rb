...
module APIv2
  class Deposits < Grape::API
    ...
    params do
      optional :currency, type: String, values: ::APIv2::Services::Currencible.codes, desc: "Currency value contains  #{ ::APIv2::Services::Currencible.codes.join(',')}"
    ...
    params do
      requires :currency, type: String, values: ::APIv2::Services::Currencible.codes, desc: "The account to which you want to deposit. Available values: #{ ::APIv2::Services::Currencible.codes.join(', ') }"
    end
