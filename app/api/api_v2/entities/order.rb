module APIv2
  module Entities
    class Order < Base
      ...
      expose :state, documentation: "One of 'wait', 'done', or 'cancel'. An order in 'wait' is an active order, waiting fullfillment; a 'done' order is an order fulfilled; 'cancel' means the order has been cancelled."
