...
module APIv2
  class K < Grape::API
    ...
    params do
      ...
      optional :timestamp2, type: Integer, desc: "An integer represents the seconds elapsed since Unix epoch. If set, only k-line data till that time will be returned."
    end
    get "/k" do
      get_k_json
    end
