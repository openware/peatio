      ...
      module MarketParams
        ...
        params :create_market_params do
          requires :base_unit,
                   ...
                   desc: -> { V2::Admin::Entities::Market.documentation[:base_unit][:desc] }
          requires :quote_unit,
                   type: String,
                   values: { value: -> { ::Currency.ids }, message: 'admin.market.currency_doesnt_exist' },
                   desc: -> { V2::Admin::Entities::Market.documentation[:quote_unit][:desc] }
          optional :ask_fee,
          ...
          optional :min_price,
                   ...
                   default: 0.0,
                   desc: -> { V2::Admin::Entities::Market.documentation[:min_price][:desc] }
          optional :max_price,
                   ...
                   default: 0.0,
                   desc: -> { V2::Admin::Entities::Market.documentation[:max_price][:desc] }
          optional :min_amount,
                   ...
                   default: 0.0,
                   desc: -> { V2::Admin::Entities::Market.documentation[:min_amount][:desc] }
          optional :amount_precision,
                   ...
                   default: 0,
                   desc: -> { V2::Admin::Entities::Market.documentation[:amount_precision][:desc] }
          optional :price_precision,
                   ...
                   default: 0,
                   desc: -> { V2::Admin::Entities::Market.documentation[:price_precision][:desc] }
          optional :position,
          ...
          optional :state,
                   ...
                   default: 'enabled',
                   desc: -> { V2::Admin::Entities::Market.documentation[:state][:desc] }
        end
