describe Ethereum1::Wallet do
  let(:wallet) { Ethereum1::Wallet.new }
  ...
  context :configure do
    ...
    it 'sets settings attribute' do
      ...
      expect(wallet.settings).to eq(settings.slice(*Ethereum1::Wallet::SUPPORTED_SETTINGS))
    end
  end
