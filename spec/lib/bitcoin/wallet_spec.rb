describe Bitcoin::Wallet do
  ...
  context :configure do
    ...
    it 'requires wallet and currency' do
      expect{ wallet.configure(settings.except(:wallet)) }.to raise_error(Peatio::Blockchain::MissingSettingError)
      expect{ wallet.configure(settings.except(:currency)) }.to raise_error(Peatio::Blockchain::MissingSettingError)
