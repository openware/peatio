      ...
      { jsonrpc: '2.0',
        ...
        result:  {
          ...
          transactions:     [{ hash:             '0xc6ef2fc5426d6ad6fd9e2a26abeab0aa2411b7ab17f30a99d3cb96aed1d1055b',
                               ...
                               input:            'a9059cbb000000000000000000000000085h43d8a49eeb85d32cf465507dd71d507100c100000000000000000000000000000000000000000000000000000000001e8480'
                             }]
        }
      }.to_json
    end
  ...
  describe '#load_deposit!' do
    ...
    let :response_body do
      { jsonrpc: '2.0',
        ...
        result:
                 {
                   blockHash:         '0x2327990cda5c1ea2968b7e9b8913fae81efbd36a5aa1789d3ba5dfbbc1548f76',
                   blockNumber:       '0x20ccf8',
                   cumulativeGasUsed: '0xc8e1',
                   from:              '0xdd61c7d5a1213af4a7b589f6e557cce3fcc0cfbb',
                   gasUsed:           '0xc8e1',
                   logs:
                                      [
                                        {
                                          ...
                                          blockNumber:      '0x20ccf8',
                                          transactionHash:  '0xc496f09c00916b4e40f2ae6e05d3c8927689e4b447e914064fb9213c380bf965',
                   ...
                   logsBloom:         '',
                   status:            '0x1',
                   to:                '0x87099add3bcc0821b5b151307c147215f839a110',
                   transactionHash:   '0xc496f09c00916b4e40f2ae6e05d3c8927689e4b447e914064fb9213c380bf965',
                   transactionIndex:  '0x0'
    ...
    it do
      is_expected.to eq({
                          ...
                          confirmations: 17370,
                          entries:       [{ amount:  JSON.parse(response_body)['result']['logs'].first['data'].hex.to_f / 10 ** client.currency.precision,
                                            address: '0x' + JSON.parse(response_body)['result']['logs'].first['topics'].last[-40..-1] }]
                        })
    end
  end
