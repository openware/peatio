...
describe API::V2::Market::Trades, type: :request do
  ...
  let!(:ask_futures_trade) { create(:trade, :btc_usd_1903, ask: ask_futures, market: ask_futures.market, created_at: 10.minutes.ago) }
  let!(:bid_futures_trade) { create(:trade, :btc_usd_1903, bid: bid_futures, market: bid_futures.market, created_at: 2.minutes.ago) }
