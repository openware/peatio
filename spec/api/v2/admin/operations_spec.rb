  ...
  describe 'GET' do
    ...
    context 'expenses' do
      ...
      it 'fileters by created_at_to' do
        api_get '/api/v2/admin/expenses', token: token, params: { created_at_to: 3.days.ago.to_i }
        result = JSON.parse(response.body)
      ...
      it 'filters by created_at_from' do
        api_get '/api/v2/admin/expenses', token: token, params: { created_at_from: 3.days.ago.to_i }
        result = JSON.parse(response.body)
        expected = expenses.select { |l| l.created_at >= 3.days.ago }
