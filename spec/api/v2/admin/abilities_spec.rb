  ...
  describe 'GET /api/v2/admin/abilities' do
    context 'member role' do
      ...
      it 'get all roles and permissions' do
        ...
        expect(result).to eq(
          "manage" => ["Operations::Account", "Operations::Asset", "Operations::Expense", "Operations::Liability", "Operations::Revenue", "Member", "Account", "Beneficiary", "PaymentAddress", "Deposit", "Withdraw", "WithdrawLimit", "Blockchain", "Currency", "Engine", "Market", "TradingFee", "Wallet", "Adjustment", "WhitelistedSmartContract"],
          "read" => ["Trade", "Order"],
          "update" => ["Order"],
        )
      end
