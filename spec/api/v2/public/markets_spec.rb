...
describe API::V2::Public::Markets, type: :request do
  ...
  describe 'GET /api/v2/markets/tickers' do
    ...
    context 'single trade was executed' do
      ...
      before do
        Workers::AMQP::MarketTicker.new.process(trade.as_json)
      end
    ...
    context 'multiple trades were executed' do
      ...
      before do
        Workers::AMQP::MarketTicker.new.process(trade1.as_json)
        Workers::AMQP::MarketTicker.new.process(trade2.as_json)
      end
