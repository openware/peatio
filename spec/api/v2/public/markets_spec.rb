...
describe API::V2::Public::Markets, type: :request do
  ...
  describe 'GET /api/v2/markets/tickers' do
    it 'returns ticker of all markets' do
      ...
      expect(JSON.parse(response.body)['btcusd']['ticker']).to eq ({ 'buy' => '0.0', 'sell' => '0.0', 'low' => '0.0', 'high' => '0.0', 'open' => '0.0', 'last' => '0.0', 'vol' => '0.0', 'price' => '0.0', 'change' => '0.0' })
    end
  end
  ...
  describe 'GET /api/v2/public/markets/:market/tickers' do
    it 'returns market tickers' do
      ...
      expect(response).to be_success
      expect(JSON.parse(response.body)['ticker']).to eq ({ 'buy' => '0.0', 'sell' => '0.0', 'low' => '0.0', 'high' => '0.0', 'open' => '0.0', 'last' => '0.0', 'vol' => '0.0', 'price' => '0.0', 'change' => '0.0' })
    end
  end
