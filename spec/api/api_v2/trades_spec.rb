describe APIv2::Trades, type: :request do
  ...
  describe 'GET /api/v2/trades' do
    it 'should return all recent trades' do
      get '/api/v2/trades', market: "btc#{Peatio.base_fiat_ccy.downcase}"
    ...
    it 'should return 1 trade' do
      get '/api/v2/trades', market: "btc#{Peatio.base_fiat_ccy.downcase}", limit: 1
    ...
    it 'should return trades before timestamp' do
      ...
      get '/api/v2/trades', market: "btc#{Peatio.base_fiat_ccy.downcase}", timestamp: 8.hours.ago.to_i, limit: 1
      expect(response).to be_success
    ...
    it 'should return trades between id range' do
      ...
      get '/api/v2/trades', market: "btc#{Peatio.base_fiat_ccy.downcase}", from: ask_trade.id, to: another.id
      expect(response).to be_success
    ...
    it 'should get trades by from and limit' do
      ...
      get '/api/v2/trades', market: "btc#{Peatio.base_fiat_ccy.downcase}", from: ask_trade.id, limit: 1, order_by: 'asc'
  ...
  describe 'GET /api/v2/trades/my' do
    it 'should require authentication' do
      get '/api/v2/trades/my', market: "btc#{Peatio.base_fiat_ccy.downcase}", access_key: 'test', tonce: time_to_milliseconds, signature: 'test'
    ...
    it 'should return all my recent trades' do
      signed_get '/api/v2/trades/my', params: { market: "btc#{Peatio.base_fiat_ccy.downcase}" }, token: token
      expect(response).to be_success
    ...
    it 'should return 1 trade' do
      signed_get '/api/v2/trades/my', params: { market: "btc#{Peatio.base_fiat_ccy.downcase}", limit: 1 }, token: token
    ...
    it 'should return trades before timestamp' do
      signed_get '/api/v2/trades/my', params: { market: "btc#{Peatio.base_fiat_ccy.downcase}", timestamp: 30.hours.ago.to_i }, token: token
    ...
    it 'should return limit out of range error' do
      signed_get '/api/v2/trades/my', params: { market: "btc#{Peatio.base_fiat_ccy.downcase}", limit: 1024 }, token: token
