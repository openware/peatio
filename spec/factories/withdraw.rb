...
FactoryBot.define do
  ...
  factory :nxt_withdraw, class: Withdraws::Coin do
    ...
    account do
      member.get_account(:nxt).tap do |a|
        a.balance = 50
        a.save(validate: false)
      end
    end
  ...
  factory :testp_withdraw, class: Withdraws::Coin do
    ...
    account do
      member.get_account(:testp).tap do |a|
        a.balance = 50
        a.save(validate: false)
      end
    end
  ...
  factory :testa_withdraw, class: Withdraws::Coin do
    ...
    account do
      member.get_account(:testa).tap do |a|
        a.balance = 50
        a.save(validate: false)
      end
    end
