module Eos
    ...
    class Blockchain < Peatio::Blockchain::Abstract
      ...
      def fetch_block!(block_number)
        # block_hash = client.json_rpc(:getblock, [block_number])

        client.json_rpc(:getblock, [block_number])
      ...
      def latest_block_number
        client.json_rpc(:getinfo).fetch('head_block_num')
      end
      ...
      def client
        @client ||= Eos::Client.new(settings_fetch(:server))
      end
