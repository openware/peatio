...
ActiveRecord::Schema.define(version: 20181213052609) do
  ...
  create_table "markets", force: :cascade do |t|
    ...
    t.decimal  "margin_rate",                  precision: 32, scale: 16, default: 0.1,    null: false
  ...
  create_table "positions", force: :cascade do |t|
    t.integer  "member_id",  limit: 4,                                          null: false
    t.string   "market_id",  limit: 20,                                         null: false
    t.integer  "volume",     limit: 4,                            default: 0,   null: false
  ...
  add_index "positions", ["member_id", "market_id"], name: "index_positions_on_member_id_and_market_id", unique: true, using: :btree
